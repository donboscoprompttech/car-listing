...
return view('cars.index',compact('testimonial','bannerfirst','brands','vehicletype','vehicletypecars','questions','make','model','year','footerimg','question1img','question2img','videoimg','video','globe'));
}
catch (exception $e) {
...
$maxpricearr=explode("$",$maxprice1);
$maxpriceval=$maxpricearr[1];
$minpricearr=explode("$",$minprice1);
...
$year = DB::select(DB::raw($sqlQuery));
        ...
        return view('cars.search',compact('testimonial','brands','questions','vehicletypecars','searchresult','footerimg','question1img','question2img','videoimg','make','model','year','maxprice','minprice','globe'));
