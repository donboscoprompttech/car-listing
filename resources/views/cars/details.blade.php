        ...
        <div class="row footer-row">
            <div class="col-lg-4">
                <div class="logo-div">
                    ...
                    <img src="{{ asset('car/assets/images/logo.png') }}" class="img-fluid footer-logo" alt="">
                </span>
                    <p class="logo-title">
                ...
                <div class="desc-div">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor et dolore magna
                    aliqua. Ut enim
            ...
            <div class="col-lg-4 col-md-4 ps-lg-5">
                ...
                <ul class="footer-list">
                    <li><a href=""><span class="icon-span"><img src="{{ asset('car/assets/images/Icons/location.svg') }}"
                                    class="footer-icon" alt=""></span>Dubai , 128 Town, Dubai 1367 UAE</a></li>
                    <li><a href=""><span class="icon-span"><img src="{{ asset('car/assets/images/Icons/phone-call.svg') }}"
                                    class="footer-icon" alt=""></span>Phone : 1 - 877 - 3453 - 3726</a></li>
                    ...
                    <li><a href=""><span class="icon-span"><img src="{{ asset('car/assets/images/Icons/email.svg') }}" class="footer-icon"
                                    alt=""></span>Email : info@car-listing.com</a></li>
                </ul>
            </div>
        </div>
