                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu text-center">
                                                <button class="btn btn-secondary" onclick="editBanner({{$row->id}}, `{!!$row->title!!}`, `{!!$row->policy!!}`)" data-toggle="modal" data-target="#editBannerModal">Edit</button>
                                                ...
                                                <form id="delete_Banner_form{{$row->id}}" action="{{ route('privacy.delete', $row->id) }}" method="POST">
                                                    @csrf
                                                </form>
                                            </div>
                                        </div>
...
<div class="modal fade" id="createBannerModal" tabindex="-1" role="dialog" aria-labelledby="createBannerModalModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('privacy.store') }}" method="POST" enctype="multipart/form-data" id="privacyStore">
                @csrf
                <div class="modal-header">
                <h5 class="modal-title" id="createBannerModalModalLabel">Create Privacy & Policy</h5>
            ...
            <form action="{{ route('privacy.update') }}" method="POST" enctype="multipart/form-data" id="editPrivacyForm">
                ...
                <div class="modal-body">
                    <div class="container">
                        ...
                        <div class="form-group my-2">
                            <label for="Privacy & Policy">Privacy & Policy</label>
                            <textarea type="text" name="privacy" class="form-control" id="privacy_policy" placeholder="Privacy & Policy"></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
