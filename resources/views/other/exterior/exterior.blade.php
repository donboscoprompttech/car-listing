                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu text-center">
                                                ...
                                                <form id="delete_Banner_form{{$row->id}}" action="{{ route('exterior.delete', $row->id) }}" method="POST">
                                                    @csrf
                                                </form>
                                            </div>
                                        </div>
...
<div class="modal fade" id="editBannerModal" tabindex="-1" role="dialog" aria-labelledby="editBannerModalModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('exterior.update') }}" method="POST" enctype="multipart/form-data" id="editPrivacyForm">
                @csrf
