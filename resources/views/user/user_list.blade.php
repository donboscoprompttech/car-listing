                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu text-center">
                                                <a href="{{ route('user.view', $row->id) }}"><button class="btn btn-primary my-2">View</button></a>
                                                <a href="{{ route('user.edit', $row->id) }}"><button class="btn btn-secondary my-2">Edit</button></a>
